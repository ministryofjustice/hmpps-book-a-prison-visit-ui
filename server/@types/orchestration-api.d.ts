...
export interface paths {
  ...
  '/prisoner/{prisonerId}/visitors/{visitorIds}/basic-details': {
    /**
     * Get visitor(s) basic details
     * @description Get visitor(s) basic details
     */
    get: operations['getVisitorsBasicDetails']
  }
  '/prisoner/{prisonerIds}/basic-details': {
    /**
     * Get a prisoner's basic details
     * @description Get the prisoner's basic details
     */
    get: operations['getPrisonersBasicDetails']
  }
