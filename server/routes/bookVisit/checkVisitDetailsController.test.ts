...
describe('Check visit details', () => {
    ...
    it('should render check visit details page', () => {
      return request(app)
        ...
        .expect(res => {
          ...
          expect($('[data-test="prisoner-details"]').text()).toBe('John Smith at Hewell (HMP & YOI)')
  ...
  describe(`POST ${paths.BOOK_VISIT.CHECK_DETAILS}`, () => {
    ...
    describe('Visit BOOKED (AUTO_APPROVED)', () => {
      const visitBooked = TestData.visitDto({ visitSubStatus: 'AUTO_APPROVED' })
